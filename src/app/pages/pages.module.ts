...
@NgModule({
  declarations: [MainComponent, ParallaxComponent, CiudadaniaComponent, EspacioComponent, EspacioPublicoComponent, SobreElSitioComponent, LaCiudadaniaYLosDerechosHumanosComponent, UnEspacioYUnaDemocraciaPorConstruirComponent, PensarConImagenesComponent, InspiracionesComponent, RecorridoFotograficoComponent, BibliografiaComponent, ActividadesParaElAulaComponent, LasoComponent, WolfComponent, EijkelboomComponent],
